...
**/Users/florianoswald/actions-runner/_work/JPE-Tincani-20180648/JPE-Tincani-20180648/replication-package/Replication_Package_Tincani-20180648/code/stata/16_main_effects_and_rob.do**

- Line 424, : indistinguishable: the p-values for equality are 0.413 for test scores and 0.371 for GPA."
...
- Line 265, : gen intensity_alu=19.781-5.927*log_adj_dis+0.00087*adjusted_distance if adjusted_distance>=0 & adjusted_distance<=600
- Line 337, : replace exp_reconstruction_alu_lca= cprA_hat*0.001 if intensity_alu_cat==5
- Line 338, : replace exp_reconstruction_alu_lca=cprA_hat*0.011+cprB_hat*0.001 if intensity_alu_cat==6
- Line 339, : replace exp_reconstruction_alu_lca=cprA_hat*0.084 + cprB_hat*0.017+cprCD_hat*0.0055 if intensity_alu_cat==7
- Line 340, : replace exp_reconstruction_alu_lca=cprA_hat*0.337 + cprB_hat*0.084+cprCD_hat*0.0165 if intensity_alu_cat==8
- Line 341, : replace exp_reconstruction_alu_lca=cprA_hat*0.69 + cprB_hat*0.337+cprCD_hat*0.053 if intensity_alu_cat==9
- Line 380, : Ratio: 75,725/589,627 = 0.1284, or approximately 13% of the sample
- Line 556, : gen intensity_rbd=19.781-5.927*log_adj_dis_rbd+0.00087*adjusted_distance_rbd if adjusted_distance_rbd>=0 & adjusted_distance_rbd<=600
